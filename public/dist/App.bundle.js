...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 44.7866;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20.4489;
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        ...
        var placeholder = $('.placeholder__text');
        if (location.text() == '') {
          location.after('<hr>');
        }
